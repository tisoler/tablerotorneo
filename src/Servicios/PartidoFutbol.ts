...
export const ObtenerPartidoFutbolActual = async (idDisciplinaClub: number): Promise<PartidoFutbol | null> => {
    try {
      const res = await fetch(`${REACT_APP_BACKEND_URL}/partidoFutbolActual/${idDisciplinaClub}`)
